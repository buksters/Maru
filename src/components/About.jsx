      ...
      <div className="page-wrapper">
        ...
        <div className='page-content'>
          <div className="about-text">
            <p>Hi, and welcome to my blog! If you don't already know me, my name is Ibuki, and I'm a designer and creative technologist. You can check out my portfolio and learn more about me <a target="_blank" href='https://ibukiwasaki.com'>here</a>. <br></br><br></br> So why a blog? I go into more detail about it in my <Link to="/archive/getting-over-fears">first post</Link> but, as a serial overthinker, this is my endeavor to think less and do more. I'll mainly be using this as a platform to post some thoughts and experiments as they occur. This website itself started as an experiment to learn Three.js and React.<br></br><br></br>
